...
#image = cv2.imread(r"C:\Users\Aishu\black.jpg")
...
def mask(image):
    ...
    _, contours, hierarchy = cv2.findContours(img_th,cv2.RETR_CCOMP,cv2.CHAIN_APPROX_SIMPLE)
...
if(blurr==0):
    mask(image);
    #image1 = Image.open(r"C:\Users\Aishu\crop2.png")
    #enhance_img(image1);
